...
hashes. The runs span revisions: only final DO50 used the final installed
fresh-tangent wheel; H20 loaded the preceding integration but never activated
...
The 0.1.4 wheel's 129 Python files were compared with the final cold-qualified
...
The release 0.1.4 wheel also passed all 92 installed-package tests in 92.63
